/* eslint-disable max-len -- This showcase embeds a demo image as a data URL. */
import {
  IonAvatar,
  IonContent,
  IonHeader,
          ...
          <IonItem className={'showCaseItem'} lines='none'>
            <IonAvatar>
              <img
                ...
                decoding='async'
                alt=''
                src='https://avatars.githubusercontent.com/u/8546082?s=200&v=4'
              />
            </IonAvatar>
            <IonLabel>
          ...
          <IonItem className={'showCaseItem'} lines='none'>
            <IonAvatar>
              <img
                ...
                decoding='async'
                alt=''
                src='https://lostpebble.github.io/pullstate/img/icon-transparent-onlight-new.png'
              />
            </IonAvatar>
            <IonLabel>
              <h2>PullState</h2>
